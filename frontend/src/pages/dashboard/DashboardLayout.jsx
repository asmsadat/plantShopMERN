  ...
  return (
    <section className="flex md:bg-gray-100 min-h-screen overflow-hidden">
      ...
      <div className="flex-grow text-gray-800">
        <header className="flex items-center justify-center h-20 px-6 sm:px-10 bg-white">
          ...
          <div className="relative w-full max-w-md sm:-ml-2 text-center">
        ...
        <main className="p-6 sm:p-10 space-y-6 ">
          <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
            <div className="flex flex-col md:flex-row items-start justify-end -mb-3 ml-auto">
              <Link
                to="/dashboard/manage-product"
                className="inline-flex px-5 py-3 text-green-600 hover:text-green-800 focus:text-green-700 hover:bg-green-100 focus:bg-green-100 border border-green-600 rounded-md mb-3"
              >
                <svg
                  aria-hidden="true"
                  fill="none"
